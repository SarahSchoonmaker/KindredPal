...
import { MessageCircle, UserX, MapPin } from "lucide-react-native";
      ...
      {connections.map((connection) => (
        <View key={connection._id} style={styles.card}>
          <TouchableOpacity
            ...
            onPress={() => navigation.navigate("UserProfile", { userId: connection._id })}
          >
            <Image
            ...
            <View style={styles.info}>
              ...
              {connection.age && (
                <Text style={styles.age}>{connection.age} years old</Text>
              )}
          ...
          <View style={styles.actions}>
            ...
            <TouchableOpacity
              ...
              onPress={() => handleUnmatch(connection)}
            >
