// CLEAN-RESEED-SCRIPT.js
// This completely clears the database and reseeds with new user structure
...
async function cleanAndReseed() {
  try {
    ...
    // Create new users with correct structure
    const createdUsers = await User.insertMany(sampleUsers);
    console.log(
      `✅ Created ${createdUsers.length} new users with updated structure`,
    );
