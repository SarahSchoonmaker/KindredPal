...
export default function Profile() {
  ...
  // FIX: use direct api.delete() call instead of userAPI.deleteAccount()
  // The original called user.softDelete() on the backend which may not exist
  // on the User model. The new backend route uses findByIdAndUpdate directly.
    ...
    <div style={S.page}>
      ...
      {showDelete && (
        <ConfirmModal
          ...
          message="This will permanently delete your account and all your data including groups, connections, and messages. This cannot be undone."
      ...
      {/* Step 2 — final confirmation before actually deleting */}
      {showDeleteConfirm && (
        <ConfirmModal
          title="Are you absolutely sure?"
          message="This is your last chance. Clicking 'Delete Forever' will permanently remove your KindredPal account and cannot be reversed."
